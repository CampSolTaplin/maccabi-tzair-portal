...
export default function ChangePasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Refresh the local session so the new user_metadata (without
      // must_change_password) lands in the client JWT before we navigate.
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-brand-navy/5 p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-brand-muted mt-1.5">
              You&apos;re using the default password. Please choose a new one
              to continue.
            </p>
          </div>
